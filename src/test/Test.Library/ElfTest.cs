...
namespace Test.Library
{
    public class ElfTest
    {
        ...
        //Se prueba que el valor total de la vida (con su protección) del elfo sea el esperado despues de recibir un daño ataque en especifico.
        {   
            //Act
            int expectedElfHealth = 100;
            elf.RecieveAttack(135);
